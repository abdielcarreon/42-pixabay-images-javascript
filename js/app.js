...
function validarFormulario(e) {
    ...
    if(terminoBusqueda === '') {
        mostrarAlerta('Agrega término de búsqueda');
        return;
    }
...
function mostrarAlerta(mensaje) {
    ...
    if(!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-100', 'text-red-700', 'px-4', 'py-3', 'rounded', 'max-w-lg', 'mx-auto', 'mt-6', 'text-center' );
...
async function buscarImagenes() {
    ...
    const key = '42931857-accf30519befe29c473f3dd7b';
